    ...
    with tf.variable_scope(name, reuse = reuse):
        ...
        for i in range(FLAGS.repeat_B-1): 
            ...
            if i == 1:        
               ...
               x = Conv2d(x,output_dim =FLAGS.fil_num_2, k_h = 1, k_w = 1, strides =[1, 1, 1, 1],name ='conv_1_1',is_train = is_train,BN = BN)
...
#    asas
    ...
    try:
        while not coord.should_stop():
            ...
            _,lr_val,summary_str,Accuracy_,train_loss_mean,prediction_,train_labels_ = sess.run([optim,lr,summary_op,accuracy,loss_train,prediction,train_labels])
